namespace OOP2DiceRollGameExpanded
{
    public class Statistics
    {
        ...
        /// <summary>
        /// displays the statistics to the player
        /// </summary>
        public static void DisplayStatistics() {
            ...
            foreach(string line in lines) {
                // splits the lines into parts with a comma
                string[] parts = line.Split(',');
                // displays these parts to the user
                Console.WriteLine($"Game Name: {parts[0]}\nHighScore: {parts[1]}\nTimes Played: {parts[2]}");
            }
        }
